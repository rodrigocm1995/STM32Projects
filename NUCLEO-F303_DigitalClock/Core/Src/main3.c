/* ALTERNATIVA 3: Divisor de frecuencia por Software en TIM3 (Interrupcion de 5 ms)
 * Levanta una bandera cada 4 ciclos (20 ms) en la interrupcion, liberando el bucle while(1).
 */
