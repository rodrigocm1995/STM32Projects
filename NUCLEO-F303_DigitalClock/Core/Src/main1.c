/* ALTERNATIVA 1: Temporizador de Software no bloqueante (Tick Polling con HAL_GetTick())
 * Evita el uso de HAL_Delay() al ejecutar tareas periodicamente de forma cooperativa.
 */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    if ((currentTick - lastTaskTick) >= 20U)
    {
