...
int main(void)
{
  ...
  INA236_SetAverage(&ina236, INA236_512_SAMPLES);
  ...
  while (1)
  {
    isDataReady = INA236_IsConversionReady(&ina236);
    ...
    if (isDataReady)
    {
      ...
      snprintf(msg, sizeof(msg), "Shunt Voltage = %.2f mV\r\n", shuntVoltage);
      HAL_UART_Transmit(&huart2, (uint8_t *)msg, strlen(msg), HAL_MAX_DELAY);

      snprintf(msg, sizeof(msg), "Bus Voltage = %.2f V\r\n", busVoltage);
      HAL_UART_Transmit(&huart2, (uint8_t *)msg, strlen(msg), HAL_MAX_DELAY);

      snprintf(msg, sizeof(msg), "Current = %.3f A\r\n", current);
      HAL_UART_Transmit(&huart2, (uint8_t *)msg, strlen(msg), HAL_MAX_DELAY);

      snprintf(msg, sizeof(msg), "Power = %.3f W\r\n", power);
      HAL_UART_Transmit(&huart2, (uint8_t *)msg, strlen(msg), HAL_MAX_DELAY);
